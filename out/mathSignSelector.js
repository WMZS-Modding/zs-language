...
exports.ZSDivisionSignSelector = exports.ZSMultiplicationSignSelector = exports.ZSMinusSignSelector = void 0;
...
class ZSMultiplicationSignSelector {
    static activate(context) {
...
exports.ZSMultiplicationSignSelector = ZSMultiplicationSignSelector;
ZSMultiplicationSignSelector.isActive = false;
ZSMultiplicationSignSelector.lastChangeTime = 0;
class ZSDivisionSignSelector {
    static activate(context) {
...
exports.ZSDivisionSignSelector = ZSDivisionSignSelector;
ZSDivisionSignSelector.isActive = false;
ZSDivisionSignSelector.lastChangeTime = 0;
